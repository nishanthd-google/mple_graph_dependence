...
from pygcn.layers import MLPLayer, InteractionUnit
...
class PMLE_Linear(nn.Module):
    def __init__(self, nhidden, nclass, dropout):
        super(PMLE_Linear, self).__init__()

        self.linear = nn.Linear(nhidden, nclass)
